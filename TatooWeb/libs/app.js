...
var App = function () {
    ...
    var handlePortletTools = function () {
        ...
        //this will be handle in the backendHandler
        //jQuery('body').on('click', '.portlet > .portlet-title > .tools > a.reload', function (e) {
        //    e.preventDefault();
        //    var el = jQuery(this).closest(".portlet").children(".portlet-body");
        //    App.blockUI(el);
        //    //blockUI will be handle by ajax call
    ...
    var handleMessageShow = function () {
    ...
    return {
        ...
        init: function () {
            ...
            handleMessageShow(); //handle message show hide
        },
        ...
        blockUI: function (el, centerY) {
            ...
            el.block({
                message: '<img src="/Content/images/ajax-loading.gif" align="">',
